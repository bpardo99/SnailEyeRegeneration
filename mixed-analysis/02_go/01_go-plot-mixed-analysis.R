...
#Load data
##BP terms
bp<- read.xlsx(here("mixed-analysis/02_go/20230401-terms-from-gofigure-selection-BP.xlsx"))
##CC terms
cc<- read.xlsx(here("mixed-analysis/02_go/20230401-terms-from-gofigure-selection-CC.xlsx"))
##MF terms
mf<- read.xlsx(here("mixed-analysis/02_go/20230401-terms-from-gofigure-selection-MF.xlsx"))
